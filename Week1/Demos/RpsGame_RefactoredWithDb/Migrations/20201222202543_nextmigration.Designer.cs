...
namespace RpsGame_NoDb.Migrations
{
    ...
    [Migration("20201222202543_nextmigration")]
            ...
            modelBuilder.Entity("RpsGame_NoDb.Match", b =>
                {
                    ...
                    b.Property<Guid?>("TiePlayerPlayerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RpsGame_NoDb.Match", b =>
                {
                    ...
                    b.HasOne("RpsGame_NoDb.Player", "TiePlayer")
                        .WithMany()
                        .HasForeignKey("TiePlayerPlayerId");

                    b.Navigation("Player1");

                    b.Navigation("Player2");

                    b.Navigation("TiePlayer");
                });
